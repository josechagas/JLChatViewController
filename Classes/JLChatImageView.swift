...
open class JLChatImageView: UIImageView {
    ...
    */
    ...
    open func addImage(_ image:UIImage,ApplyingMask mask:UIImage?){
        ...
        if useBubbleForm,let mask = mask{
            ...
            DispatchQueue.global(qos: DispatchQoS.QoSClass.userInitiated).async {
                ...
                if let resizedMask = UIGraphicsGetImageFromCurrentImageContext(), let maskReference = resizedMask.cgImage{
                    //-----
                    ...
                    if let imageMask = imageMask{
                        ...
                        print("failed to create imageMask")
                    }
                }
                else{
    ...
    /**
     This method instanciaty , configure and add an 'UIActivityIndicatorView' instance to JLChatImageView
     */
